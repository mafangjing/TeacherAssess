...
//    self = [[OTCover alloc] initWithFrame:bounds];
    self = [[OTCover alloc]initWithFrame:CGRectMake(0, 64, bounds.size.width, bounds.size.height)];
...
//    self.tableView = [[UITableView alloc] initWithFrame:self.frame];
    self.tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, bounds.size.width, bounds.size.height - 64)];
